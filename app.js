...
app.use(async (ctx, next) => {
	...
	// if (ctx.request.method.toUpperCase() === "POST" && (ctx.query == null || !Object.keys(ctx.query).length)) {
...
router.use('/airdrops', require('./app/controller/airdrops.js'))
router.use('/signTest', require('./routes/signTest.js'))
router.use('/upload', require('./routes/upload.js'))
router.use('/import', require('./routes/import.js'))
