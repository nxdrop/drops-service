...
|名称|位置|类型|必选|说明|
|---|---|---|---|---|
|info|query|string| 是 |一批空投的描述，主要用于前端展示，string类型|
|merkleRoot|query|string| 是 |这批空投的merkleRoot，string类型|
|description|query|string| 是 |A human readable description of the item. Markdown is supported. |
|external_url|query|string| 是 |This is the URL that will appear below the asset's image on OpenSea and will allow users to leave OpenSea and view the item on your site. |
